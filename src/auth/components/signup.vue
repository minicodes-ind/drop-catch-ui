                ...
                if(this.repassword==this.signupModel.password){
                    ...
                    fetch(`${this.API_URL}/api/sendemail/8124`, {
                        ...
                        body: JSON.stringify({
                            ...
                            subject: `${otp} is you Dropcatch OTP`
                        })
            ...
            <div class="p-grid p-fluid">
                ...
                <div class="p-col-12 p-lg-3 box">
                    <div class="p-inputgroup">
                        ...
                        <input  class = "tb" type="text" pInputText v-model="signupModel.email" placeholder="Email">         
                    </div>
                </div>
                ...
                <div v-show="this.isOtpSent" class="loginbutton">
                    <Button  @click="signup()" type="button" label="Verify and Signup"
                    class="   lb"></Button>
                </div>

                <div v-show="!this.isOtpSent" class="loginbutton">
                    <Button  @click="sendOTP()" type="button" label="Send OTP Mail"
                    class="   lb"></Button>
                </div>
