...
<template>
    ...
    <div class="container fade-in-from-right">
        ...
        <p>At <b>Dropcatch</b>, accessible from <b>www.mydropcatch.in </b>, one of our main priorities is the privacy of our
            visitors. This Privacy Policy document contains types of information that is collected and recorded by
            <b>www.mydropcatch.in</b> and how we use it.</p>



        <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards
            to the information that they shared and/or collect in <b>www.mydropcatch.in</b>. This policy is not applicable
        ...
        <p><b>www.mydropcatch.in</b> follows a standard procedure of using log files. These files log visitors when they
        ...
        <P>You may consult this list to find the Privacy Policy for each of the advertising partners of
            <b>www.mydropcatch.in</b>.</p>

        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
            their respective advertisements and links that appear on <b>www.mydropcatch.in</b>, which are sent directly to
        ...
        <p>Note that <b>www.mydropcatch.in</b> has no access to or control over these cookies that are used by third-party
            advertisers.</p>

        <h2>Third Party Privacy Policies</h2>

        <p><b>www.mydropcatch.in</b>'s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
    ...
    <h2>Contact Us</h2>
    <p>If you have any questions or suggestions about my Privacy Policy, do not hesitate to contact me a
        <b>dropcatchalert@outlook.com</b>.</p>
